require([ 'jquery', 'app', 'main-nav-bar', 'main-view'], function($, app) {
  ...
  $mainView.main_view('createView', 'welcome', $('<div style="margin-left: 100px; margin-right:100px"><h1 style="align:center;">QbiQe Project!</h1>This is page will populate information as a dashboard!<br><br>Please click on Flowchart at the left bar panel.</div>'));
