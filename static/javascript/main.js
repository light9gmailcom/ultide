require([ 'jquery', 'app', 'main-nav-bar', 'main-view'], function($, app) {
  ...
  $mainView.main_view('createView', 'welcome', $('<div style="margin-left: 100px; margin-right:100px"><h1 style="align:center;">Q Project!</h1>This is page is dashboard. You can find all result from the last resutl here!<br><br>Please click on Design at the left bar panel.</div>'));
